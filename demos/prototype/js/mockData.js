  ...
  guidelines: [
    {
      ...
      currentValue: 33,
      delta: -12.0,
      insight: "人氣雙品組合（橄欖油 × 麵包）購買率從 45% 降至 33%，拖累新客轉換與平均訂單金額。",
      suggestion: "建立「人氣雙品組合」專區，搭配加價購提示並在活動頁強調一次購足免運，拉回組合轉換。",
    ...
    },
    {
      ...
      currentValue: 1.8,
      delta: -0.6,
      insight: "新品活動頁轉換率由 2.4% 降至 1.8%，CTA 點擊與頁尾社會證明不足。",
      suggestion: "更新 Hero 區標題、加入真實社會證明，並針對 CTA 與結帳流程進行 A/B 測試以降低跳出率。",
  ...
  tasks: [
    {
      ...
      title: "建立人氣雙品組合專區",
      description: "重新設計商品組合陳列，強調一次購足免運與搭配食譜指引",
      category: "商品策略",
      assignee: "商品企劃組",
      priority: "high",
      status: "進行中",
    ...
    },
    {
      ...
      title: "優化新品活動頁 CTA 與流程",
      description: "調整 Hero 區與 CTA 用詞，新增社會證明並串接 A/B 測試",
      category: "轉換率",
      assignee: "成長設計組",
      priority: "high",
      status: "未開始",
